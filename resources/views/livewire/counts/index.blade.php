                          ...
                          <table class=' w-full '>
                            ...
                            <tbody>
                                @foreach ($getcomptes as $comptes)    
                                    ...
                                    <td>
                                      <span class='text-xs text-left font-semibold  text-[#141B27] flex justify-start gap-1 py-2'>{{ $comptes->nom_avec}}</span>
                                    </td>
                                    ...
                                    <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                      <span class='pb-2'>{{ $comptes->nombrecycle_avec + $comptes->nombrecycle_avec}}</span>
                                    </td>
