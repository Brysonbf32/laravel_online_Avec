                                ...
                                @foreach ($getrole as $role)    
                                    <tr class='hover:bg-slate-50 border-t h-5 border-slate-200'>                    
                                        <td class='text-xs text-left font-semibold  text-[#141B27] flex justify-start gap-1 py-2'>
                                            <span class=' pl-4 pt-3 '>{{ $role->id}}</span>
                                        </td>
                                        <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                        <span class='pb-2'>{{ $role->name}}</span>
                                        </td>
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <div wire:click="deletepermission({{ $role->id }})" wire:confirm="Permission Deleted successfully" class="w-7 h-7 rounded-full bg-slate-200 text-center  py-1.5  hover:bg-cyan-500 hover:text-white cursor-pointer transition ease-in-out duration-500">
                                            ...
                                            <div class="w-7 h-7 rounded-full bg-slate-200 text-center  py-1.5  hover:bg-cyan-500 hover:text-white cursor-pointer transition ease-in-out duration-500" >
                                                <a href="{{ url('role/'.$role->id.'/rolepermission')}}" wire:navigate><i class="fa fa-eye"></i></a>
                                            </div>
