                        ...
                        <div class="overflow-y-auto overflow-x-hidden flex-grow">
                            <ul class="flex flex-col py-4 space-y-1">
                                <li class="px-5">
                                    ...
                                    <li>
                                        <a href="{{ route('hp')}}" wire:navigate class="relative flex flex-row items-center h-11 focus:outline-none 
                                    ...
                                    <li>
                                        ...
                                        >
                                        <h1 class="cursor-pointer p-2 text-xs text-gray-600 font-medium tracking-wide text-indigo500 hover:bg-gray-200 hover:text-black duration-300">
                                        <a href=" {{ route('car')}}" wire:navigate>Creation Carnet</a> 
                                        </h1>
                                        <h1 class="cursor-pointer p-2 text-xs font-medium tracking-wide text-indigo500">
                                        Personal
                                        </h1>
                                ...
                                <div class=" pt-20 px-6">
                                    <a href="{{ route('lgn')}}" wire:navigate>  Deconnexion</a>                                
                                </div>
                            </ul>
                        </div>
                    </div>
