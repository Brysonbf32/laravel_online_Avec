...
$__html = app('livewire')->mount($__name, $__params, 'HORfvgX', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'pFnpE1R', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <style>
          ...
          .colored-toast .swal2-html-container {
            ...
            <div  class="grid  sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 px-2 gap-4">
                                                    ...
                                                    <div class="grid gap-2 text-sm grid-cols-1 md:grid-cols-4 py-2">
                                                      <div class="md:col-span-2">
                                                        ...
                                                        <select class="h-10 border mt-1 rounded-sm  px-2 w-full focus:outline-none" wire:model="gestionnaires_id">
                                                            ...
                                                            ?>
                                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $gestionneur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gestio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="0">Choisie le gestionnaire</option>
                                                                <option value=" <?php echo e($gestio->id); ?>"><?php echo e($gestio->nom_gest); ?></option>
                                                      ...
                                                      <div class="md:col-span-2">
                                                        ...
                                                        <select class="h-10 border mt-1 rounded-sm  px-2 w-full focus:outline-none" wire:model="comptes_id">
                                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $avecs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $avec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="0">Choisie Avec</option>
                                                                <option value="<?php echo e($avec->id); ?>"><?php echo e($avec->nom_avec); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <!--[if ENDBLOCK]><![endif]-->
                                                        </select>
                                                      </div>
                      ...
                      <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->     
                        <div class=' bg-white rounded'>
                          <table class=' w-full '>
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $getallgestioavec; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gestioavec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                    <tr class='hover:bg-slate-50 border-t px-2 h-5 border-slate-200'>                    
                                    <td class="pl-2">
                                      <span class='text-xs text-left font-semibold  text-[#141B27] flex justify-start gap-1 py-2'><?php echo e($gestioavec->titre_attr); ?></span>
                                    </td>
                                    <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                      <span class='pb-2'><?php echo e($gestioavec->gestionnaires_id); ?></span>
                                    </td>
                                    <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                      <span class='pb-2 text-center'><?php echo e($gestioavec->comptes_id); ?></span>
                                    </td>
                                    <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                      <span class='pb-2'><?php echo e($gestioavec->status_attr); ?></span>
                                    </td>
                                    <td class='text-xs text-right font-normal  text-[#141B27] '>
                                      <div class="flex gap-2">
                                                              ...
                                                              <div class="lg:col-span-4">
                                                                <form wire:submit="ajouterutilisateur"  method="POST" enctype="multipart/form-data">
                                                                  <div class="">
                                                                    ...
                                                                    <input type="text" wire:input.debounce.2000ms="edit_name(<?php echo e($gestioavec->id); ?>, $event.target.value)" value="<?php echo e($gestioavec->titre_attr); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                  </div>
                                                                  <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
       
                                                                    <div class="md:col-span-2">
                                                                      <label class="text-black" for="address">Telephone</label>
                                                                      <input type="text" wire:input.debounce.2000ms="edit_telephone(<?php echo e($gestioavec->id); ?>, $event.target.value)" value="<?php echo e($gestioavec->gestionnaires_id); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                    </div>
                                                                  </div>
                                                                </form>
                                                              </div>
                                        ...
                                        <div wire:click="deleteuser(<?php echo e($gestioavec->id); ?>)" wire:confirm="Permission Deleted successfully" class="w-7 h-7 rounded-full bg-slate-200 text-center  py-1.5  hover:bg-cyan-500 hover:text-white cursor-pointer transition ease-in-out duration-500">
                                        <i class="fa fa-trash"></i>
                                        </div>
                                        <div  wire:click="showdetailuserdata(<?php echo e($gestioavec->id); ?>)" class="w-7 h-7 rounded-full bg-slate-200 text-center  py-1.5  hover:bg-cyan-500 hover:text-white cursor-pointer transition ease-in-out duration-500" >
                                        <i class="fa fa-eye"></i>
                                        </div>
                                      </div>
                                    </td>                                                   
                ...
                <div class="">
                  <!--[if BLOCK]><![endif]--><?php if($gestionavecdetaildata): ?>
                        ...
                        <div class="col-cols-2 px-2">
                          <div class="grid grid-cols-3">
                            ...
                            <div class="text-sm text-left font-medium  text-[#141B27]/[0.6] pt-2">
                              <h1><?php echo e($gestionavecdetaildata->nom_membre); ?></h1>
                            </div>
                          </div>
                        </div>
                        <div class=" px-7">
                          <div class="grid grid-cols-3">
                            ...
                            <div class="text-sm text-left font-medium  text-[#141B27]/[0.6] pt-2">
                              <h1><?php echo e($gestionavecdetaildata->updated_at); ?></h1>
                            </div>
                          </div>
                          <div class="grid grid-cols-3">
                            <div class=" text-left text-[#141B27]/[0.6] font-bold text-sm pt-2">
                            ...
                            <div class="text-sm text-left font-medium  text-[#141B27]/[0.6] pt-2">
                              <details> <h1><?php echo e($gestionavecdetaildata->password_membre); ?></h1></details>
  ...
  <?php /**PATH C:\xampp\htdocs\fintech_avec\resources\views/livewire/counts/gestionavec.blade.php ENDPATH**/ ?>