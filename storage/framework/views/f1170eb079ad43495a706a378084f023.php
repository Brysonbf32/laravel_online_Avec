...
$__html = app('livewire')->mount($__name, $__params, 'okVISIH', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, '5UkQVmL', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <style>
          ...
          .colored-toast .swal2-html-container {
            ...
            <div  class="grid  sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 px-2 gap-4">
                      ...
                      <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->     
                        <div class=' bg-white rounded'>
                          <table class=' w-full '>
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $getgetmebre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membres): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                    <tr class='hover:bg-slate-50 border-t px-2 h-5 border-slate-200'>                    
                                    <td>
                                      <span class='text-xs text-left font-semibold  text-[#141B27] flex justify-start gap-1 py-2'><?php echo e($membres->nom_membre); ?></span>
                                    </td>
                                    <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                      <span class='pb-2'><?php echo e($membres->address_mebre); ?></span>
                                    </td>
                                    <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                      <span class='pb-2 text-center'><?php echo e($membres->telephone_membre); ?></span>
                                    </td>
                                    <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                      <span class='pb-2'><?php echo e($membres->identite_membre); ?></span>
                                    </td>
                                    <td class='text-xs text-right font-normal  text-[#141B27] '>
                                      <div class="flex gap-2">
                                                              ...
                                                              <div class="lg:col-span-4">
                                                                <form wire:submit="ajouterutilisateur"  method="POST" enctype="multipart/form-data">
                                                                  <div class="">
                                                                    ...
                                                                    <input type="text" wire:input.debounce.2000ms="edit_name(<?php echo e($membres->id); ?>, $event.target.value)" value="<?php echo e($membres->nom_membre); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                  </div>
                                                                  <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
       
                                                                    <div class="md:col-span-2">
                                                                      <label class="text-black" for="address">Telephone</label>
                                                                      <input type="text" wire:input.debounce.2000ms="edit_telephone(<?php echo e($membres->id); ?>, $event.target.value)" value="<?php echo e($membres->telephone_membre); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                    </div>
                                                                    <div class="md:col-span-2">
                                                                      <label class="text-black" for="email">Address</label>
                                                                      <input type="text" wire:input.debounce.2000ms="edit_adddres(<?php echo e($membres->id); ?>, $event.target.value)" value="<?php echo e($membres->address_mebre); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                    </div>
                                                                    <div class="md:col-span-2">
                                                                      <label class="text-black" for="city">Carte d'indentite</label>
                                                                      <input type="text" wire:input.debounce.2000ms="edit_carteident(<?php echo e($membres->id); ?>, $event.target.value)" value="<?php echo e($membres->identite_membre); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                    </div>
                                                                    <div class="md:col-span-2">
                                                                      <label class="text-black" for="city">Mot de passe</label>
                                                                      <input type="text" wire:input.debounce.2000ms="edit_password(<?php echo e($membres->id); ?>, $event.target.value)" value="<?php echo e($membres->password_membre); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                    </div>
                                                                  </div>
                                                                </form>
                                                              </div>
                                        ...
                                        <div wire:click="deleteuser(<?php echo e($membres->id); ?>)" wire:confirm="Permission Deleted successfully" class="w-7 h-7 rounded-full bg-slate-200 text-center  py-1.5  hover:bg-cyan-500 hover:text-white cursor-pointer transition ease-in-out duration-500">
                                        <i class="fa fa-trash"></i>
                                        </div>
                                        <div  wire:click="showdetailuserdata(<?php echo e($membres->id); ?>)" class="w-7 h-7 rounded-full bg-slate-200 text-center  py-1.5  hover:bg-cyan-500 hover:text-white cursor-pointer transition ease-in-out duration-500" >
                                        <i class="fa fa-eye"></i>
                                        </div>
                                      </div>
                                    </td>                                                   
                ...
                <div class="">
                  <!--[if BLOCK]><![endif]--><?php if($membreionnairedetaildata): ?>
                        ...
                        <div class="col-cols-2 px-2">
                          <div class="grid grid-cols-3">
                            ...
                            <div class="text-sm text-left font-medium  text-[#141B27]/[0.6] pt-2">
                              <h1><?php echo e($membreionnairedetaildata->nom_membre); ?></h1>
                            </div>
                          </div>
                        </div>
                        <div class=" px-7">
                          <div class="grid grid-cols-3">
                            ...
                            <div class="text-sm text-left font-medium  text-[#141B27]/[0.6] pt-2">
                              <h1><?php echo e($membreionnairedetaildata->updated_at); ?></h1>
                            </div>
                          </div>
                          <div class="grid grid-cols-3">
                            <div class=" text-left text-[#141B27]/[0.6] font-bold text-sm pt-2">
                            ...
                            <div class="text-sm text-left font-medium  text-[#141B27]/[0.6] pt-2">
                              <details> <h1><?php echo e($membreionnairedetaildata->password_membre); ?></h1></details>
  ...
  <?php /**PATH C:\xampp\htdocs\fintech_avec\resources\views/livewire/counts/membres.blade.php ENDPATH**/ ?>