...
$__html = app('livewire')->mount($__name, $__params, 'RfqbwLZ', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'd5UtcD1', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div  class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 px-2 gap-4">
                ...
                <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
                    <div class="flex justify-between  px-4 bg-slate-100">
                        <div class=" flex gap-2">
                            <div>
                                <span class="text-sm font-semibold px-2 text-blue-400">Role</span>
                            </div>
                        </div>
                        <div>
                            <div x-data x-on:click="$dispatch('open-modal2')" class="text-sm  px-2 w-7 h-7 bg-slate-100 text-centr rounded-full pt-1 place-content-center mb-0 font-weight-bold text-gray-800">
                    ...
                    <div class="px-4 ">
                        ...
                        <div class=' bg-white rounded'>
                          <table class=' w-full '>
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $getrole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                    <tr class='hover:bg-slate-50 border-t h-5 border-slate-200'>                    
                                        <td class='text-xs text-left font-semibold  text-[#141B27] flex justify-start gap-1 py-2'>
                                            <span class=' pl-4 pt-3 '><?php echo e($role->id); ?></span>
                                        </td>
                                        <td class='text-xs text-left font-semibold  text-[#141B27] pb-1'>
                                        <span class='pb-2'><?php echo e($role->name); ?></span>
                                        </td>
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <div wire:click="deletepermission(<?php echo e($role->id); ?>)" wire:confirm="Permission Deleted successfully" class="w-7 h-7 rounded-full bg-slate-200 text-center  py-1.5  hover:bg-cyan-500 hover:text-white cursor-pointer transition ease-in-out duration-500">
                                            ...
                                            <div class="w-7 h-7 rounded-full bg-slate-200 text-center  py-1.5  hover:bg-cyan-500 hover:text-white cursor-pointer transition ease-in-out duration-500" >
                                                <a href="<?php echo e(url('role/'.$role->id.'/rolepermission')); ?>" wire:navigate><i class="fa fa-eye"></i></a>
                                            </div>
                ...
                <div 
                    x-data="{ show : false }"
                    x-on:open-modal2.window = "show = true"
                            ...
                            <div  class="bg-white rounded shadow-lg p-4 px-2 md:p-8 mb-6">
                                <div class=" pl-7 grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                                    ...
                                    <div class="lg:col-span-2">
                                        <form wire:submit="createrole"  method="POST">
                                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-3">
                                                ...
                                                <div class="md:col-span-5 text-right pr-9">
                                                    <div class="inline-flex items-end" x-on:Click="isOpen = false">
                                                        ...
                                                        <span wire:target="createrole" wire:loading.remove> <i class="fas fa-plus"></i> Register</span>
                                                        <span wire:target="createrole" wire:loading>  Loading ...</span>
                                                        </button>
                                                    </div>
  ...
  <?php /**PATH C:\xampp\htdocs\fintech_avec\resources\views/livewire/role-permission/roles/index.blade.php ENDPATH**/ ?>