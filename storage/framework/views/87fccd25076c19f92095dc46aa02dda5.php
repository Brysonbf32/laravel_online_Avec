<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <div>
      <!--[if BLOCK]><![endif]--><?php if(session()->has('Password_error')): ?> 
        <div class=" bg-red-100 px-4 py-2 rounded-md">
            <p class="font-sans text-sm text-slate-500"><?php echo e(session('Password_error')); ?></p>
        </div>
      <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
      <!--[if BLOCK]><![endif]--><?php if(session()->has('UserMail_error')): ?> 
      <div class=" bg-red-100 px-4 py-2 rounded-md">
          <p class="font-sans text-sm text-slate-500"><?php echo e(session('UserMail_error')); ?></p>
      </div>
    <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
    </div>
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      ...
      <a href="<?php echo e(route('sgn')); ?>" wire:navigate class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sign Up</a>
    </p>
  </div>
</div><?php /**PATH C:\xampp\htdocs\fintech_avec\resources\views/livewire/login.blade.php ENDPATH**/ ?>