...
$__html = app('livewire')->mount($__name, $__params, '1MdmGMt', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'TsIDuCG', $__slots ?? [], get_defined_vars());
...
?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $getusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                    <tr class='hover:bg-slate-50 border-t h-5 border-slate-200'>                    
                                      <td class='text-xs text-left font-semibold  text-[#141B27] flex justify-start gap-1 py-2'>
                                        <span class='pl-4'><img class='border border-slate-100 h-50 w-48 rounded-sm'  src="<?php echo e(asset($user->user_image)); ?>"/>
                                        </span>
                                        <span class='pt-3  px-2'><?php echo e($user->user_email); ?></span>
                                    </td>
                              ...
                              <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                                ...
                                <div class="md:col-span-2">
                                  ...
                                  <select wire:model="user_role" class="h-10 border mt-1 rounded-sm px-2 w-full  focus:outline-none">
                                    ...
                                    <option class="text-sm" value="Admin">Administrateur</option>
                                    <option value="SAdmin" class="text-sm">Sous Admin</option>
                                    <option value="User" class="text-sm">User</option>
                                ...
                                <div class="md:col-span-5 text-right pr-4">
                                  <div class="inline-flex items-end" x-on:Click="isOpen = false">
                                    ...
                                    <span wire:target="register" wire:loading.remove> Register <i class="fas fa-plus"></i></span>
  ...
  <?php /**PATH C:\xampp\htdocs\fintech_avec\resources\views/livewire/d-users/index.blade.php ENDPATH**/ ?>