                            ...
                            <ul class="flex flex-col py-4 space-y-1">
                                ...
                                <li>
                                    ...
                                    <li>
                                        ...
                                        <a href=" <?php echo e(route('us')); ?>" wire:navigate>Users</a> 
                                        </h1>
                                        <h1 class="cursor-pointer p-2 text-xs font-medium tracking-wide text-indigo500">
                                            <a href=" <?php echo e(route('permi')); ?>" wire:navigate>Permission</a> 
                                        </h1>
                                        <h1 class="cursor-pointer p-2 text-xs font-medium tracking-wide text-indigo500">
                                            <a href=" <?php echo e(route('role')); ?>" wire:navigate>Role</a> 
                                        </h1>
                                        <h1 class="cursor-pointer p-2 text-xs font-medium tracking-wide text-indigo500">
                                        Friends
                                        </h1>
                                    ...
                                    <li>
                                        ...
                                        >
                                        <h1 class="cursor-pointer p-2 text-xs text-gray-600 font-medium tracking-wide text-indigo500 hover:bg-gray-200 hover:text-black duration-300">
                                        <a href=" <?php echo e(route('carne')); ?>" wire:navigate>Creation Carnet</a> 
                                        </h1>
                                        <h1 class="cursor-pointer p-2 text-xs font-medium tracking-wide text-indigo500">
                                        Personal
                                        </h1>
...
<?php /**PATH C:\xampp\htdocs\fintech_avec\resources\views/livewire/include/sidebar.blade.php ENDPATH**/ ?>