...
$__html = app('livewire')->mount($__name, $__params, 'sBRIfJV', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'F3GFxgX', $__slots ?? [], get_defined_vars());
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $getusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                            <tr class='hover:bg-slate-50 border-t h-5 border-slate-200'>                    
                              <td class='text-xs text-left font-semibold  text-[#141B27] flex justify-start gap-1 py-2' x-data="{ updatephoto_modal: false }">
                                ...
                                <span class='pt-3  px-1'><i class="fa fa-camera"  @click="updatephoto_modal =!updatephoto_modal"></i>&nbsp;&nbsp;<?php echo e($user->user_username); ?></span>
                                                        ...
                                                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                                                          <div class="md:col-span-2">
                                                            <label for="uploadFile1"
                                                                ...
                                                                Televerser
                                                                <input type="file" id='uploadFile1'  wire:model="user_image" wire:input.debounce.2000ms="edit_image(<?php echo e($user->id); ?>, $event.target.value)" value="<?php echo e($user->user_username); ?>" class="hidden" />
                                                              </label>
                                                          </div>
                                                            ...
                                                            <form wire:submit="ajouterutilisateur"  method="POST" enctype="multipart/form-data">
                                                              <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                                                                <div class="md:col-span-2">
                                                                  ...
                                                                  <input type="text" wire:input.debounce.2000ms="edit_name(<?php echo e($user->id); ?>, $event.target.value)" value="<?php echo e($user->user_username); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                </div>
                                                                <div class="md:col-span-2">
                                                                  <label class="text-black" for="email">Email Address</label>
                                                                  <input type="text" wire:input.debounce.2000ms="edit_mail(<?php echo e($user->id); ?>, $event.target.value)" value="<?php echo e($user->user_email); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                </div>
                                                                <div class="md:col-span-2">
                                                                  <label class="text-black" for="city">Password</label>
                                                                  <input type="text" wire:input.debounce.2000ms="edit_password(<?php echo e($user->id); ?>, $event.target.value)" value="<?php echo e($user->user_password); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                </div>
                                                                <div class="md:col-span-2">
                                                                  <label class="text-black" for="city">Role</label>
                                                                  <select wire:model="user_role" class="h-10 border mt-1 rounded-sm px-2 w-full  focus:outline-none">
                                                                    <option class="text-sm">Choose Role</option>
                                                                    <input type="text" wire:input.debounce.2000ms="edit_role(<?php echo e($user->id); ?>, $event.target.value)" value="<?php echo e($user->user_role); ?>" class="h-10 border mt-1 rounded-sm text-black px-2 w-full focus:outline-none" />
                                                                    <option class="text-sm" value="AD">Administrateur</option>
                                                                    <option value="SA" class="text-sm">Sous Admin</option>
                                                                    <option value="US" class="text-sm">User</option>
...
<?php /**PATH C:\xampp\htdocs\fintech_avec\resources\views/livewire/users/create-users.blade.php ENDPATH**/ ?>